<?php
	if ($action != 'team') {
		    ...
		    $titel = utf8_decode("16. Holzkirchner Marktlauf");
		    ...
		    //Calculate width of title and position
		    $datum = utf8_decode("am 31. Oktober 2021");
		    ...
		    $this->SetFont('Verdana','B',16);
		    //Calculate width of title and position
		    $titel = utf8_decode("14. Holzkirchner Marktlauf");
		    $w=$this->GetStringWidth($titel);
		    $this->SetX((210-$w)/2); // Mitte
		    $this->SetTextColor(0);
		    $this->Cell($w,20,$titel,0,0,'C',false);
		    ...
		    $this->SetFont('Verdana','',12);
		    //Calculate width of title and position
		    $datum = utf8_decode("am 27. Oktober 2019");
		    $w=$this->GetStringWidth($datum);
		    $this->SetX((210-$w)/2); // Mitte
		    $this->SetTextColor(0);
		    $this->Cell($w,20,$datum,0,0,'C',false);
